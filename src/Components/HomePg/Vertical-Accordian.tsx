...
const VerticalAccordian = () => {
  ...
  return (
    <>
      <div className="VerticalAccordian">
        <div
          className={
            interact1
              ? bigSmall1
          ...
          <div className="container">
            ...
            {bigSmall1 && (
              <div className="top_line_and_main_text">
                ...
                <p className="main_text">
                  It works by creating a mild vacuum effect, which helps
                  stimulate natural healing processes in your body.
                </p>
                <p className="main_text">
